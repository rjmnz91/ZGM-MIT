    ...
    <div class="panel panel-info">
     <div class="panel panel-heading">
         <table style="width:100%; text-align:center;">
             <tr>
                 <td style="text-transform:uppercase"><strong><asp:Localize runat="server" ID="Cabecera" Text="<%$ Resources:Resource, SolicitudesCabecera%>"/></strong></td>
                 <td Style="text-transform:uppercase"><strong><asp:Localize runat="server" ID="Soldia" Text="<%$ Resources:Resource, SolicitudDia%>"/></strong></td>
             </tr>
             <tr>
                 <td>
                     <center><asp:DropDownList ID="ddlEstados" runat="server" DataSourceID="SDSEstados" DataTextField="Resource" DataValueField="IdEstado" AutoPostBack="true" CssClass="form-control"  ondatabound="ddlEstados_DataBound" Width="45%"/></center>
                 </td>
                 <td>
                     <center>
                         <asp:TextBox name="date" id="fecha" runat="server"  onmouseover="return overlib('Selecciona Fecha.');" onmouseout="return nd();" style="width: 108px; text-align:right;" class="form-control" ontextchanged="fecha_TextChanged" Width="45%" AutoPostBack="True" />
                     </center>
                 </td>
             </tr>
         </table>
         ...
         <div id="tabs" class="container" style="width: 95%;">
            ...
            <div id="Almacen" class="container">
                <asp:GridView ID="grdSolicitudes" runat="server" AutoGenerateColumns="False" SkinId="gridviewSkin"
                    ...
                    onselectedindexchanged="grdSolicitudes_SelectedIndexChanged" Width="95%">
                    <RowStyle BackColor="White" ForeColor="Black" />
                <AlternatingRowStyle BackColor="PaleTurquoise" ForeColor="Black" />
                <Columns>
                    <asp:CommandField ButtonType="Button" SelectText="✚"  ControlStyle-ForeColor="Black"
                        ShowSelectButton="True"  >
                    <ControlStyle Width="40px" />
                    <ItemStyle CssClass="btn btn-primary" />
                    </asp:CommandField>
                        ...
                        SortExpression="EstadoSolicitudResource">
                            <ItemTemplate>
                                <div class="divContainerDdlSolicitud">
                                    <asp:DropDownList ID="ddlEstadoSolicitud" runat="server" CssClass="form-control" Width="100px" 
            ...
            <div id="Otras" style="display:none;">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:Resource, Tienda %>" 
                        SortExpression="EstadoSolicitudResource">
                            <ItemTemplate>
                                    <asp:DropDownList ID="ddlIdTienda" runat="server" CssClass="form-control" Width="100px" OnSelectedIndexChanged="ddlIdTiendaSolicitud_SelectedIndexChanged" AutoPostBack="true"  >
                                    </asp:DropDownList>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="Proveedor" 
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:Resource, Estado %>" 
                        SortExpression="EstadoSolicitudResource">
                            <ItemTemplate>
                                    <asp:DropDownList ID="ddlEstadoSolicitud" runat="server" CssClass="form-control" Width="100px" OnSelectedIndexChanged="ddlEstadoSolicitudotros_SelectedIndexChanged" AutoPostBack="true"  >
                                    </asp:DropDownList>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="FechaPedido" 
