        ...
        <tr 
            ...
            <td><asp:DropDownList ID="ddlEstados" runat="server" DataSourceID="SDSEstados" 
                DataTextField="Resource" DataValueField="IdEstado" AutoPostBack="true"
                    CssClass="form-control" onselectedindexchanged="ddlEstados_SelectedIndexChanged" 
                    ondatabound="ddlEstados_DataBound"/>
            </td>
        </tr>
        <tr style="background-color:paleturquoise;">
            <td></td>
            <td><input type="button" id="btnImprimir" onclick="window.print();" value="<% = Resources.Resource.Imprimir %>" class="btn btn-primary" /></td>
        </tr>
    </table>
