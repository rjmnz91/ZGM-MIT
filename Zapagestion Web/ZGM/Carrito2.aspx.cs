...
namespace AVE
{
    public partial class Carrito2 : CLS.Cls_Session
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (HiddenTipoCliente.Value.ToString() == "E")
            //{
        ...
        protected void cmdConfirmarEntrega_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string szInsertEntrega = string.Format("INSERT INTO MC_Piagui.dbo.AVE_CARRITO_ENTREGAS" +
