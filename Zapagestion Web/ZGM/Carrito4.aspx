<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Carrito4.aspx.cs" Inherits="AVE.Carrito4" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-top: 10px" id="divDetalle" runat="server">
        ...
        <div>
<%--        <asp:UpdatePanel runat="server" ID="updPnlCarrito" UpdateMode="Conditional">
            <ContentTemplate>
--%>                <asp:SqlDataSource ID="AVE_CarritoObtener" runat="server" ConnectionString="<%$ ConnectionStrings:MC_TDAConnectionString %>"
                    ...
                    DeleteCommand="AVE_eliminaLineaCarrito" DeleteCommandType="StoredProcedure" >
                    <DeleteParameters>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton runat="server" Style="width: 25px; height: 25px" ID="imgBorrar" ImageUrl="~/img/Remove.png"
                                    CommandArgument='<%# Eval("id_carrito_detalle") %>' OnClick="imgBorrar_Click" OnClientClick="javascript:return ValidarEliminarCarrito();"  />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
...
--%>        </div>
    ...
    <div style="margin-top: 10px" id="divResumen" runat="server" visible="false">
        ...
        id="divPagos" visible="true" class="divPagos">
         <div style="margin-top: 2px; border-style: solid; width: 90%; border-width:0px;margin-left:2px;" 
            ...
            <asp:DropDownList ID="LstClientes" CssClass="ocul1" Width="80%"  runat="server" 
                 onselectedindexchanged="LstClientes_SelectedIndexChanged" AutoPostBack="true" onChange="return ValidarClienteSelecionado()" ></asp:DropDownList>
            <asp:Button ID="BtnCliente" runat="server" Text="..." onclick="BCliente_Click" Width="8%"/><br />
            <table style="width:90%;">
                <tr>
                    <td style="width:150px;">
                        <div id="divFiltroBusqueda" >
                            ...
                            <asp:RadioButton ID="optCliente9" runat="server" Text="Cliente 9"  CssClass="Ocultarcontrol optCliente9" Onclick="HacerClickPonerTarjeta('9');"  />
                            <asp:RadioButton ID="optTarjetaMit" runat="server" Text="Tarjeta MIT"  CssClass="Ocultarcontrol optTarjetaMit" Onclick="HacerClickPonerTarjeta('T');" />
                        </div>
                    </td>
                    <td>
             ...
             <%--<asp:Button ID="ButClient" runat="server"  Text="..." onclick="BC9_Click" Width="8%"/><br />--%>
            <%-- <asp:RadioButton ID="Cliente9" runat="server" Text="Cliente 9" CssClass="RellenoCarrito" />
             ...
             <br />
              <div runat="server" visible="false" id="CLiente" style="display:inline-block;border-style:solid;width: 45%;padding:2px;border-width:1px"  >    
          ...
          <div runat="server" id="DivTajeta" style="display:none; border-style: solid;float:right;width: 45%;padding:2px;border-width:1px" >
            <label style="font-weight: bold">Seleciona Tarjeta</label>
              <asp:DropDownList ID="lstTarjetas" runat="server" width="60%" 
          ...
          <br />
          <div id="DivPagar" style="display:none;width:50%;padding:2px;clear:right;float:right;border-width:1px;border-style:solid" >
          <table style="width:100%">
                <tr>
...
<%--         <div style="display:inline-block;border-style: solid;float:right;width: 45%;border-width:1px">
             <label style="font-weight: bold;font-size:medium;">Numero de Tarjeta Cliente</label><br />
             <asp:TextBox ID="TarjetaCliente" runat="server" Width="85%"></asp:TextBox>
          </div>
--%>            
     </div>
