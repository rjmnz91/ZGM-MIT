...
namespace AVE
{
    public partial class Carrito8 : System.Web.UI.Page
    {
        ...
        private void BuscarClienteNine(string sTarjeta)
        {
            ...
            String url = System.Configuration.ConfigurationManager.AppSettings["URL_WS_C9"].ToString().Substring(0, System.Configuration.ConfigurationManager.AppSettings["URL_WS_C9"].ToString().LastIndexOf("/") + 1);

            if (!Comun.RemoteFileExists(url, 1000))
            {
                ScriptManager.RegisterStartupScript(this, typeof(Page), "Fidelity", "alert('El Servicio de Fidelity no esta accesible.');", true);
                return;
            } 
            ...
            else
            {
                ...
                if (c9.GetblnHomologadoC9(sTarjeta)) //, Int64.Parse(nomcliente.Text.ToString())))
                {
                    ...
                    Session["NumeroTarjetaClienteNine"] = sTarjeta;
