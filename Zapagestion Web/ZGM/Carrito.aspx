<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Carrito.aspx.cs" Inherits="AVE.Carrito" %>
                        ...
                        <ItemTemplate>
                            <div style="width: 100%; text-align: center">
                                ...
                                <div runat="server" id="laDescuento" style="width: 110px; float: left; text-align: right; margin-right: 15px; margin-left: 3%;">
                                   ...
                                   <asp:Label Style="text-transform:uppercase" runat="server" ID="Label5" Text="Descuento :" ></asp:Label>
                                </div>
                                ...
                                <asp:Label ID="divPromocionBotas" Visible="false"  runat="server" Style="clear: left; text-transform:uppercase">
    ...
    <div style="margin-top: 10px" id="divResumen" runat="server" visible="false">
        ...
        id="divPagos" runat="server" visible="true" >
         <div style="margin-top: 2px; border-style: solid; width: 50%;float:left;border-width:1px;margin-left:2px;" 
            ...
            <asp:RadioButton ID="RadioButton1" runat="server"  Text="Nota Empleado"  CssClass="Ocultarcontrol" Enabled="False" Onclick="handleClickNotaCredito(this);" ClientIDMode="Static"/>
            <br />
