<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Carrito2.aspx.cs" Inherits="AVE.Carrito2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-top: 10px" id="divDetalle" runat="server">
        ...
        <asp:GridView ID="gvCarrito" runat="server" DataKeyNames="id_carrito_detalle" AutoGenerateColumns="false"
                Style="width: 99%" GridLines="None" OnRowDataBound="gvCarrito_RowDataBound" PageSize="2"
                OnRowDeleting="gvCarrito_RowDeleting" OnRowCreated="gvCarrito_RowCreated">
                <Columns>
                    <asp:TemplateField>
        ...
        <br />
        <div runat="server" id="Total" style="margin-left: 45%; width: 260px; border: solid 1px black; float: left">
        ...
        <br />
        <asp:UpdatePanel runat="server" ID="updPnlPagos">
            <ContentTemplate>
                <div >
                </div>
            </ContentTemplate>
    ...
    <div style="margin-left: 45%; width: 260px; height: 20px; border: solid 1px black; float: left">
    ...
    <div runat="server" id="div1" style="margin-left: 45%; width: 260px; height: 20px; border: solid 1px black; float: left">
        <asp:Button ID="btnAñadirPago" runat="server" Text="Añadir Pago" />
    </div>
    <br />
    <br />
    <div runat="server"  style="margin-top: 30px; border-style: solid;  display:block;clear:left; overflow:hidden;width:98%;border-width:1px;border-width:1px" 
        id="divPagos" visible="true" >
         <div style="margin-top: 2px; border-style: solid; width: 50%;float:left;border-width:1px;margin-left:2px;" 
            ...
            <asp:RadioButton ID="RadioButton1" runat="server"  Text="Nota Empleado"  Onclick="handleClickNotaCredito(this);" ClientIDMode="Static"/>
            <br />
