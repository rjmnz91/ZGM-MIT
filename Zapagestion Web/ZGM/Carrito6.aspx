<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Carrito6.aspx.cs" Inherits="AVE.Carrito6" %>
...
<%--        <br />
        ...
        <div>
            ...
            <asp:GridView ID="gvCarrito" runat="server" DataKeyNames="id_carrito_detalle" AutoGenerateColumns="False"
                ...
                OnRowCreated="gvCarrito_RowCreated" OnInit="gvCarrito_Init" 
                DataSourceID="AVE_CarritoObtener" CellPadding="4" ForeColor="#333333" 
                ShowFooter="True" >
        ...
        id="divPagos" runat="server" visible="true" >
         ...
         <div style="display:inline-block;border-style: solid;float:right;width: 45%;border-width:1px">
          ...
          <div runat="server"  id="DivTajeta" style="display:none;border-style: solid;float:right;width: 45%;padding:2px;border-width:1px" >
            <label style="font-weight: bold">Seleciona Tipo Pago</label>
              <asp:DropDownList ID="DropDowntIPOpAGO" runat="server" width="60%"> 
