<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    MaintainScrollPositionOnPostback="true" CodeBehind="CarritoDetalle.aspx.cs" Inherits="AVE.CarritoDetalle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showCte() {
            var pnl = document.getElementById("ctl00_ContentPlaceHolder1_divPnlPagoCte");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:Button ID="BtnPagar" CssClass="btn btn-info" Style="display: none" runat="server" Text="Pagar" OnClick="ButPagar_Click" OnClientClick="mostrar_procesar();" />
                                                        </td>
                    ...
                    <asp:Panel runat="server" ID="pnlOtraObicacion" Visible="false">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtOUNoExterior" Width="90%"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <br />
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtOUNoInterior" Width="90%"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <br />
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtOUCiudad" Width="90%"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <br />
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtOUColonia" Width="90%"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <br />
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtOUCodigoPostal" Width="90%"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <br />
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtOUTelfCelular" Width="90%"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <br />
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtOUTelfFijo" Width="90%"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <br />
                                <asp:TextBox CssClass="form-control" runat="server" ID="txtOUReferenciaLlegada" Width="90%"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <asp:Button runat="server" ID="cmdConfirmarEntrega" Text="Confirmar Entrega" 
                                    Width="90%" onclick="cmdConfirmarEntrega_Click" CssClass="btn btn-primary"/>
   ...
   <table style="width: 99%" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                * Datos de Entrega Por Articulo
                                <asp:TextBox runat="server" ID="txtNombreArt" Width="90%" CssClass="form-control"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtApellidosArt" Width="90%" CssClass="form-control"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtEmailArt" Width="90%" CssClass="form-control"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtDireccionArt" Width="90%" CssClass="form-control"/>  
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtExteriorArt" Width="90%" CssClass="form-control"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtInteriorArt" Width="90%" CssClass="form-control"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtCiudadArt" Width="90%" CssClass="form-control"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtColoniaArt" Width="90%" CssClass="form-control"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtCpArt" Width="90%" CssClass="form-control"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtCelArt" Width="90%" CssClass="form-control"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtTelArt" Width="90%" CssClass="form-control"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtObservacionesArt" Width="90%" CssClass="form-control"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
