...
namespace AVE
{
    public partial class CarritoDetalle : CLS.Cls_Session
    {
        ...
        string mit = "", mitCard = "", merchId = "", merchVal = "";
        //
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    divPnlPagoCte.Style.Clear();
                    object email = Session["clientEmail"];
        ...
        protected void ButPagar_Click2(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Constantes.Paginas.Carrito + "$"+totArt + "=" + totPago + "=" + mit + "=" + mitCard + "=" + merchId + "=" + merchVal);
        }
