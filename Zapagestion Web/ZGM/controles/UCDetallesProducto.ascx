...
<%--<uc1:UCCLiente9 runat="server" ID="UCCLiente9" />--%>
    ...
    <table>
        ...
        <tr style="background-color:paleturquoise;">
            <td >
                <asp:Label Style="text-transform:uppercase" ID="LtrReferencia" runat="server" Text="<%$ Resources:Resource, Referencia%>" CssClass="negrita"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label Style="text-transform:uppercase" ID="LtrDescripcion" runat="server" Text="<%$ Resources:Resource, Descripcion%>" CssClass="negrita"></asp:Label>
            </td>
            <td>
        ...
        <tr style="background-color:paleturquoise;">
            <td>
                <asp:Label Style="text-transform:uppercase" ID="LtrColor" runat="server" Text="<%$ Resources:Resource, Color%>" CssClass="negrita"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label Style="text-transform:uppercase" ID="LtrObservaciones" runat="server" Text="<%$ Resources:Resource, Observaciones%>" CssClass="negrita"></asp:Label>
            </td>
            <td>
                <asp:Label Style="text-transform:uppercase" ID="lblObservaciones" runat="server"></asp:Label>
            </td>
        </tr>
        <tr style="background-color:paleturquoise;">
            <td>
                <asp:Label Style="text-transform:uppercase" ID="LtrCSObservaciones" runat="server" Text="<%$ Resources:Resource, ObservacionesCS%>" CssClass="negrita" Visible="false"></asp:Label>
            </td>
            <td>
                <asp:Label Style="text-transform:uppercase" ID="lblCSObservaciones" runat="server" Visible="false"></asp:Label>
            </td>
        </tr>
        <tr style="visibility:collapse;" >
            <td>
                <asp:Label Style="text-transform:uppercase" ID="LtrModelo" runat="server" 
                    Text="<%$ Resources:Resource, Modelo %>" CssClass="negrita" Visible="False" ></asp:Label>
            </td>
            <td>
