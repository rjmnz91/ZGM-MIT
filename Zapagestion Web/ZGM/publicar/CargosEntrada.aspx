<%@ Page Title="<%$ Resources:Resource, CargosEntrada%>" Language="C#" Theme="Tema" AutoEventWireup="true" CodeBehind="CargosEntrada.aspx.cs" Inherits="AVE.CargosEntrada" %>
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <table width="auto" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="2">
                        <asp:TextBox ID="txtBusquedaCargo" runat="server" TabIndex="1" CssClass="txtBuscar2" MaxLength="50"></asp:TextBox>
                        <asp:RangeValidator ID="rnvPedido" runat="server" ControlToValidate="txtBusquedaCargo" Type="Integer" ErrorMessage="*" 
                        ValidationGroup="Buscar" CssClass="mensajeRequerido2"></asp:RangeValidator>
                        <asp:RequiredFieldValidator ID="rfvPedido" runat="server" ControlToValidate="txtBusquedaCargo" ErrorMessage="*"
                ...
                <tr>
                     <td colspan="2">
                        &nbsp;<asp:Label ID="lblTitTotCargo" runat="server" Text="<%$ Resources:Resource, TotalPedido%>" CssClass="negrita"></asp:Label>
            ...
            <%--OBTENER CARGO EN EL PRIMER ACCESO--%>
            <asp:SqlDataSource ID="sdsObtenerCargoPrimerAcceso" runat="server"
                ConnectionString="<%$ ConnectionStrings:MC_TDAConnectionString %>" 
                SelectCommand="dbo.AVE_CargosEntradaBuscar" SelectCommandType="StoredProcedure">
                <SelectParameters>
             ...
             <%--CREACIÓN DEL CARGO DE ENTRADA--%>
            <asp:SqlDataSource ID="sdsCrearCargoEntrada" runat="server"
                ConnectionString="<%$ ConnectionStrings:MC_TDAConnectionString %>" 
                InsertCommand="dbo.AVE_CargosEntradaCrear" 
                InsertCommandType="StoredProcedure" 
                oninserted="sdsCrearCargoEntrada_Inserted">
                <InsertParameters>
                    <asp:Parameter Name="IdCargo" Type="Int32" />
            ...
            <%--OBTENER CARGO DE ENTRADA--%>
            <asp:SqlDataSource ID="sdsObtenerCargoEntrada" runat="server"
                ConnectionString="<%$ ConnectionStrings:MC_TDAConnectionString %>" 
                SelectCommand="dbo.AVE_CargosEntradaObtener" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:Parameter Name="IdEntrada" Type ="Int32"/>
                </SelectParameters>
            </asp:SqlDataSource>
            
            <%--GUARDAR DETALLE CARGO ENTRADA--%>
            <asp:SqlDataSource ID="sdsGuardarDetalleCargoEntrada" runat="server"
                ConnectionString="<%$ ConnectionStrings:MC_TDAConnectionString %>" 
                InsertCommand="dbo.AVE_CargosEntradaDetalleGuardar" InsertCommandType="StoredProcedure">
                <InsertParameters>
                    <asp:Parameter Name="IdEntrada" Type ="Int32"/>
            ...
            <%--ELIMINAR CARGO ENTRADA--%>
            <asp:SqlDataSource ID="sdsBorrarCargoEntrada" runat="server"
                ConnectionString="<%$ ConnectionStrings:MC_TDAConnectionString %>" 
                DeleteCommand="dbo.AVE_CargosEntradaBorrar" DeleteCommandType="StoredProcedure">
                <DeleteParameters>
                    <asp:Parameter Name="IdEntrada" Type ="Int32"/>
                </DeleteParameters>
            </asp:SqlDataSource>
            
            <%--FINALIZAR CARGO ENTRADA--%>
            <asp:SqlDataSource ID="sdsFinalizarEntrada" runat="server"
                ConnectionString="<%$ ConnectionStrings:MC_TDAConnectionString %>" 
                UpdateCommand="dbo.AVE_CargosEntradaFinalizar" UpdateCommandType="StoredProcedure">
                <UpdateParameters>
                    <asp:Parameter Name="IdEntrada" Type ="Int32"/>
                    <asp:Parameter Name="Usuario" Type ="String"/>
                </UpdateParameters>
